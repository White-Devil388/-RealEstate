      ...
      <div className="container-custom relative z-10">
        ...
        >
          ...
          <motion.div variants={{ hidden: { opacity: 0, y: 15 }, visible: { opacity: 1, y: 0 } }} className="lg:col-span-4 space-y-4">
            ...
            >
              ...
              <div>
                ...
                <div className="text-[9px] tracking-[0.16em] uppercase text-white/45 font-mono">
                  India Pvt. Ltd.
                </div>
              </div>
            </button>
            ...
            <div className="flex flex-wrap gap-2">
              <div className="flex items-center gap-1.5 text-[11px] bg-white/[0.04] px-2.5 py-1.5 border border-white/10 text-white/75 hover:border-[var(--brass)]/40 transition-colors">
          ...
          <motion.div variants={{ hidden: { opacity: 0, y: 15 }, visible: { opacity: 1, y: 0 } }} className="lg:col-span-2 space-y-3">
            <h4 className="font-heading text-base font-semibold text-[var(--text-inverse)]">Explore</h4>
          ...
          <motion.div variants={{ hidden: { opacity: 0, y: 15 }, visible: { opacity: 1, y: 0 } }} className="lg:col-span-3 space-y-3">
            <h4 className="font-heading text-base font-semibold text-[var(--text-inverse)]">Featured Projects</h4>
          ...
          {/* Contact */}
          <motion.div variants={{ hidden: { opacity: 0, y: 15 }, visible: { opacity: 1, y: 0 } }} className="lg:col-span-3 space-y-3">
            <h4 className="font-heading text-base font-semibold text-[var(--text-inverse)]">Contact</h4>
            ...
            <form onSubmit={handleNewsletterSubmit} className="space-y-1.5 pt-1">
              <div className="text-[11px] font-semibold uppercase tracking-wider text-white/45 font-mono">Newsletter</div>
              <div className="flex">
                <input
                  type="email"
                  ...
                  className="flex-1 bg-white/[0.04] border border-white/15 border-r-0 px-3 py-2 text-xs text-white placeholder:text-white/35 focus:outline-none focus:border-[var(--brass)] transition-colors"
                  required
                />
                <button
                  type="submit"
                  className="bg-[var(--accent)] text-[var(--text-inverse)] px-3 py-2 hover:bg-[var(--accent-dark)] font-semibold text-xs transition-colors border border-[var(--accent)] cursor-pointer"
                >
                  Join
                </button>
              </div>
        ...
        {/* Legal */}
        <div className="border-t border-white/10 pt-5 flex flex-col md:flex-row items-center justify-between gap-3 text-[11px] text-white/40">
